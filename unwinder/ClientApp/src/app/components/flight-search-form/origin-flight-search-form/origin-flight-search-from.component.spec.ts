...
import { OriginFlightSearchFormComponent } from './origin-flight-search-form.component';
import { FlightSearchCitiesService } from '../../../services/flight-search-form/flight-search-cities.service';
import { BrowserAnimationsModule } from '@angular/platform-browser/animations';
import { of } from 'rxjs';
import { fakeAsync, tick, flush } from '@angular/core/testing';

describe('OriginFlightSearchFormComponent', () => {
  let component: OriginFlightSearchFormComponent;
  let fixture: ComponentFixture<OriginFlightSearchFormComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(OriginFlightSearchFormComponent);
  ...
  it('should create and initialize form control', () => {
    ...
    expect(component.citiesAutocompleteOrigin).toBeInstanceOf(FormControl);
    expect(component.citiesAutocompleteOrigin.valid).toBeFalsy();
  });
  ...
  it('should filter cities based on service response', fakeAsync(() => {
    ...
    component.citiesAutocompleteOrigin.setValue('New');
    tick(300);
    fixture.detectChanges();
  ...
  it('should return the citiesAutocompleteOrigin form control', () => {
    expect(component.originElementFormControl).toBe(
      component.citiesAutocompleteOrigin,
    );
  });
